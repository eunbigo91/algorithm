# Dijkstra's algorithm is one of the solutions to the shortest
# path problem for weighted undirected graphs

# A common implementation of Dijkstra's uses a min priority queue

# This code is from https://googleyasheck.com/dijstras-algorithm-in-python-3/
